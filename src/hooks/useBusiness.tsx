...
export function useBusiness() {
  ...
  const card = {
    ...
    BUS_NAME_UPPER: 'SAFE RIDE MOTORS INC',
    BUS_NAME_MIX: 'Safe Ride Motors Inc',
  ...
  const BUSINESS_ABOUT_DESCRIPTION1 =
    "In the midst of the global pandemic, despite the challenges posed for businesses, we opened our doors to our community — " + card.BUS_NAME_MIX +
    ", a mechanic shop with over 20 years of experience " +
    "bringing a wealth of automotive knowledge and trust to our community. ";
  const BUSINESS_ABOUT_DESCRIPTION2 =
    card.BUS_NAME_MIX + " quickly established itself as a go-to destination for car owners seeking quality service and a personalized touch. " +
    ...
    "Our mechanics at " + card.BUS_NAME_MIX + " don't just fix cars; we build lasting relationships with our clients, fostering a sense of community and trust that extends beyond the garage.";
  const BUSINESS_ABOUT_DESCRIPTION3 =
    "The reputation of " + card.BUS_NAME_MIX + " continues to grow as word spreads about our dedication to excellence and community support.";
